---
name: midnight-agent-domain-classifier
description: Agent skill ported from midnight-expert/midnight-fact-check/agents/domain-classifier.md. Trigger conditions and workflow preserved. Use when the task matches this agent's domain.
version: 0.1.0
category: midnight-agents
metadata:
  hermes:
    tags: [midnight, agent, midnight-fact-check]
    source: midnight-expert/midnight-fact-check/agents/domain-classifier.md
---
...
To invoke this agent's expertise, use: `/skill midnight-agent-domain-classifier`
To use in a kanban task, set: `skills=["midnight-agent-domain-classifier"]`
