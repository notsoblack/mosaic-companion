---
name: midnight-agent-cq-reviewer
description: Agent skill ported from midnight-expert/midnight-cq/agents/cq-reviewer.md. Trigger conditions and workflow preserved. Use when the task matches this agent's domain.
version: 0.1.0
category: midnight-agents
metadata:
  hermes:
    tags: [midnight, agent, midnight-cq]
    source: midnight-expert/midnight-cq/agents/cq-reviewer.md
---
...
To invoke this agent's expertise, use: `/skill midnight-agent-cq-reviewer`
To use in a kanban task, set: `skills=["midnight-agent-cq-reviewer"]`
