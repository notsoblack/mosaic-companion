---
name: midnight-agent-cli-tester
description: Agent skill ported from midnight-expert/midnight-verify/agents/cli-tester.md. Trigger conditions and workflow preserved. Use when the task matches this agent's domain.
version: 0.1.0
category: midnight-agents
metadata:
  hermes:
    tags: [midnight, agent, midnight-verify]
    source: midnight-expert/midnight-verify/agents/cli-tester.md
---
...
To invoke this agent's expertise, use: `/skill midnight-agent-cli-tester`
To use in a kanban task, set: `skills=["midnight-agent-cli-tester"]`
