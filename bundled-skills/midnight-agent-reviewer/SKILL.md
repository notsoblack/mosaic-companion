---
name: midnight-agent-reviewer
description: Agent skill ported from midnight-expert/compact-core/agents/reviewer.md. Trigger conditions and workflow preserved. Use when the task matches this agent's domain.
version: 0.1.0
category: midnight-agents
metadata:
  hermes:
    tags: [midnight, agent, compact-core]
    source: midnight-expert/compact-core/agents/reviewer.md
---
...
To invoke this agent's expertise, use: `/skill midnight-agent-reviewer`
To use in a kanban task, set: `skills=["midnight-agent-reviewer"]`
