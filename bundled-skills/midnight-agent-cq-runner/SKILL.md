---
name: midnight-agent-cq-runner
description: Agent skill ported from midnight-expert/midnight-cq/agents/cq-runner.md. Trigger conditions and workflow preserved. Use when the task matches this agent's domain.
version: 0.1.0
category: midnight-agents
metadata:
  hermes:
    tags: [midnight, agent, midnight-cq]
    source: midnight-expert/midnight-cq/agents/cq-runner.md
---
...
To invoke this agent's expertise, use: `/skill midnight-agent-cq-runner`
To use in a kanban task, set: `skills=["midnight-agent-cq-runner"]`
