---
name: midnight-agent-concept-explainer
description: Agent skill ported from midnight-expert/core-concepts/agents/concept-explainer.md. Trigger conditions and workflow preserved. Use when the task matches this agent's domain.
version: 0.1.0
category: midnight-agents
metadata:
  hermes:
    tags: [midnight, agent, core-concepts]
    source: midnight-expert/core-concepts/agents/concept-explainer.md
---
...
To invoke this agent's expertise, use: `/skill midnight-agent-concept-explainer`
To use in a kanban task, set: `skills=["midnight-agent-concept-explainer"]`
