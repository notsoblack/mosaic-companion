 ...
 */
export async function claimDeposit(nodeUrl, args, fetchImpl = fetch) {
    ...
    throw new Error(`Failed to claim deposit on Node Manager via /balance. Status: ${res.status}. Response: ${errorText}`);
}
